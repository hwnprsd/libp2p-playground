...
type Payload struct {
	...
	WalletAddress []byte `protobuf:"bytes,1,opt,name=walletAddress,proto3" json:"walletAddress,omitempty"`
...
func (x *Payload) GetWalletAddress() []byte {
	if x != nil {
...
var file_proto_message_proto_rawDesc = []byte{
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x77, 0x61,
	...
	0x32, 0x67, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x51, 0x0a, 0x0f, 0x53, 0x65, 0x6e, 0x64, 0x54, 0x72,
	...
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70,
...
var file_proto_message_proto_depIdxs = []int32{
	...
	0, // 1: TransactionService.SendTransaction:input_type -> Transaction
	2, // 2: TransactionService.SendTransaction:output_type -> TransactionResponse
